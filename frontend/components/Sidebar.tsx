...
export default function Sidebar() {
  ...
  const [showStudy, setShowStudy] = useState(false); // ✅ collapsed by default
    ...
    return (
      <aside className="w-14 shrink-0 border-r border-slate-800 bg-slate-950 flex flex-col h-screen items-center py-3 gap-1 overflow-y-auto">
        ...
        <button
          ...
          className="w-9 h-9 rounded-lg flex items-center justify-center text-slate-400 hover:bg-slate-800 hover:text-slate-200 transition shrink-0"
          title="New task"
        >
  ...
  // ═══════════════════════════════════════════════════════════
  return (
    <aside className="w-72 shrink-0 border-r border-slate-800 bg-slate-950 flex flex-col h-screen overflow-hidden">
      {/* ── PINNED HEADER ── */}
      ...
      <div className="border-t border-slate-800 p-3 shrink-0">
        <div className="flex items-center justify-between rounded-lg px-3 py-2 gap-2">
