...
export default function NotificationsBell() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-96 max-h-[70vh] rounded-xl border border-slate-800 bg-slate-950 shadow-2xl overflow-hidden z-50 flex flex-col">
          {/* Header */}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0 space-y-0.5">
                      ...
                      <div className="flex items-center gap-2 text-[10px] text-slate-500">
                        <span className={`rounded px-1.5 py-0.5 border ${levelColor(n.level)}`}>
                          {n.level}
                        </span>
